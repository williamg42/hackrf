...
/* -- SCT_OUTn_SET_SET0: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET0_SHIFT (0)
#define SCT_OUTn_SET_SET0_MASK (0x01 << SCT_OUTn_SET_SET0_SHIFT)
#define SCT_OUTn_SET_SET0(x) ((x) << SCT_OUTn_SET_SET0_SHIFT)

/* -- SCT_OUTn_SET_SET1: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET1_SHIFT (1)
#define SCT_OUTn_SET_SET1_MASK (0x01 << SCT_OUTn_SET_SET1_SHIFT)
#define SCT_OUTn_SET_SET1(x) ((x) << SCT_OUTn_SET_SET1_SHIFT)

/* -- SCT_OUTn_SET_SET2: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET2_SHIFT (2)
#define SCT_OUTn_SET_SET2_MASK (0x01 << SCT_OUTn_SET_SET2_SHIFT)
#define SCT_OUTn_SET_SET2(x) ((x) << SCT_OUTn_SET_SET2_SHIFT)

/* -- SCT_OUTn_SET_SET3: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET3_SHIFT (3)
#define SCT_OUTn_SET_SET3_MASK (0x01 << SCT_OUTn_SET_SET3_SHIFT)
#define SCT_OUTn_SET_SET3(x) ((x) << SCT_OUTn_SET_SET3_SHIFT)

/* -- SCT_OUTn_SET_SET4: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET4_SHIFT (4)
#define SCT_OUTn_SET_SET4_MASK (0x01 << SCT_OUTn_SET_SET4_SHIFT)
#define SCT_OUTn_SET_SET4(x) ((x) << SCT_OUTn_SET_SET4_SHIFT)

/* -- SCT_OUTn_SET_SET5: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET5_SHIFT (5)
#define SCT_OUTn_SET_SET5_MASK (0x01 << SCT_OUTn_SET_SET5_SHIFT)
#define SCT_OUTn_SET_SET5(x) ((x) << SCT_OUTn_SET_SET5_SHIFT)

/* -- SCT_OUTn_SET_SET6: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET6_SHIFT (6)
#define SCT_OUTn_SET_SET6_MASK (0x01 << SCT_OUTn_SET_SET6_SHIFT)
#define SCT_OUTn_SET_SET6(x) ((x) << SCT_OUTn_SET_SET6_SHIFT)

/* -- SCT_OUTn_SET_SET7: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET7_SHIFT (7)
#define SCT_OUTn_SET_SET7_MASK (0x01 << SCT_OUTn_SET_SET7_SHIFT)
#define SCT_OUTn_SET_SET7(x) ((x) << SCT_OUTn_SET_SET7_SHIFT)

/* -- SCT_OUTn_SET_SET8: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET8_SHIFT (8)
#define SCT_OUTn_SET_SET8_MASK (0x01 << SCT_OUTn_SET_SET8_SHIFT)
#define SCT_OUTn_SET_SET8(x) ((x) << SCT_OUTn_SET_SET8_SHIFT)

/* -- SCT_OUTn_SET_SET9: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET9_SHIFT (9)
#define SCT_OUTn_SET_SET9_MASK (0x01 << SCT_OUTn_SET_SET9_SHIFT)
#define SCT_OUTn_SET_SET9(x) ((x) << SCT_OUTn_SET_SET9_SHIFT)

/* -- SCT_OUTn_SET_SET10: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET10_SHIFT (10)
#define SCT_OUTn_SET_SET10_MASK (0x01 << SCT_OUTn_SET_SET10_SHIFT)
#define SCT_OUTn_SET_SET10(x) ((x) << SCT_OUTn_SET_SET10_SHIFT)

/* -- SCT_OUTn_SET_SET11: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET11_SHIFT (11)
#define SCT_OUTn_SET_SET11_MASK (0x01 << SCT_OUTn_SET_SET11_SHIFT)
#define SCT_OUTn_SET_SET11(x) ((x) << SCT_OUTn_SET_SET11_SHIFT)

/* -- SCT_OUTn_SET_SET12: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET12_SHIFT (12)
#define SCT_OUTn_SET_SET12_MASK (0x01 << SCT_OUTn_SET_SET12_SHIFT)
#define SCT_OUTn_SET_SET12(x) ((x) << SCT_OUTn_SET_SET12_SHIFT)

/* -- SCT_OUTn_SET_SET13: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET13_SHIFT (13)
#define SCT_OUTn_SET_SET13_MASK (0x01 << SCT_OUTn_SET_SET13_SHIFT)
#define SCT_OUTn_SET_SET13(x) ((x) << SCT_OUTn_SET_SET13_SHIFT)

/* -- SCT_OUTn_SET_SET14: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET14_SHIFT (14)
#define SCT_OUTn_SET_SET14_MASK (0x01 << SCT_OUTn_SET_SET14_SHIFT)
#define SCT_OUTn_SET_SET14(x) ((x) << SCT_OUTn_SET_SET14_SHIFT)

/* -- SCT_OUTn_SET_SET15: A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_SET_SET15_SHIFT (15)
#define SCT_OUTn_SET_SET15_MASK (0x01 << SCT_OUTn_SET_SET15_SHIFT)
#define SCT_OUTn_SET_SET15(x) ((x) << SCT_OUTn_SET_SET15_SHIFT)
...
/* -- SCT_OUTn_CLR_CLR0: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR0_SHIFT (0)
#define SCT_OUTn_CLR_CLR0_MASK (0x01 << SCT_OUTn_CLR_CLR0_SHIFT)
#define SCT_OUTn_CLR_CLR0(x) ((x) << SCT_OUTn_CLR_CLR0_SHIFT)

/* -- SCT_OUTn_CLR_CLR1: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR1_SHIFT (1)
#define SCT_OUTn_CLR_CLR1_MASK (0x01 << SCT_OUTn_CLR_CLR1_SHIFT)
#define SCT_OUTn_CLR_CLR1(x) ((x) << SCT_OUTn_CLR_CLR1_SHIFT)

/* -- SCT_OUTn_CLR_CLR2: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR2_SHIFT (2)
#define SCT_OUTn_CLR_CLR2_MASK (0x01 << SCT_OUTn_CLR_CLR2_SHIFT)
#define SCT_OUTn_CLR_CLR2(x) ((x) << SCT_OUTn_CLR_CLR2_SHIFT)

/* -- SCT_OUTn_CLR_CLR3: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR3_SHIFT (3)
#define SCT_OUTn_CLR_CLR3_MASK (0x01 << SCT_OUTn_CLR_CLR3_SHIFT)
#define SCT_OUTn_CLR_CLR3(x) ((x) << SCT_OUTn_CLR_CLR3_SHIFT)

/* -- SCT_OUTn_CLR_CLR4: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR4_SHIFT (4)
#define SCT_OUTn_CLR_CLR4_MASK (0x01 << SCT_OUTn_CLR_CLR4_SHIFT)
#define SCT_OUTn_CLR_CLR4(x) ((x) << SCT_OUTn_CLR_CLR4_SHIFT)

/* -- SCT_OUTn_CLR_CLR5: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR5_SHIFT (5)
#define SCT_OUTn_CLR_CLR5_MASK (0x01 << SCT_OUTn_CLR_CLR5_SHIFT)
#define SCT_OUTn_CLR_CLR5(x) ((x) << SCT_OUTn_CLR_CLR5_SHIFT)

/* -- SCT_OUTn_CLR_CLR6: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR6_SHIFT (6)
#define SCT_OUTn_CLR_CLR6_MASK (0x01 << SCT_OUTn_CLR_CLR6_SHIFT)
#define SCT_OUTn_CLR_CLR6(x) ((x) << SCT_OUTn_CLR_CLR6_SHIFT)

/* -- SCT_OUTn_CLR_CLR7: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR7_SHIFT (7)
#define SCT_OUTn_CLR_CLR7_MASK (0x01 << SCT_OUTn_CLR_CLR7_SHIFT)
#define SCT_OUTn_CLR_CLR7(x) ((x) << SCT_OUTn_CLR_CLR7_SHIFT)

/* -- SCT_OUTn_CLR_CLR8: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR8_SHIFT (8)
#define SCT_OUTn_CLR_CLR8_MASK (0x01 << SCT_OUTn_CLR_CLR8_SHIFT)
#define SCT_OUTn_CLR_CLR8(x) ((x) << SCT_OUTn_CLR_CLR8_SHIFT)

/* -- SCT_OUTn_CLR_CLR9: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR9_SHIFT (9)
#define SCT_OUTn_CLR_CLR9_MASK (0x01 << SCT_OUTn_CLR_CLR9_SHIFT)
#define SCT_OUTn_CLR_CLR9(x) ((x) << SCT_OUTn_CLR_CLR9_SHIFT)

/* -- SCT_OUTn_CLR_CLR10: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR10_SHIFT (10)
#define SCT_OUTn_CLR_CLR10_MASK (0x01 << SCT_OUTn_CLR_CLR10_SHIFT)
#define SCT_OUTn_CLR_CLR10(x) ((x) << SCT_OUTn_CLR_CLR10_SHIFT)

/* -- SCT_OUTn_CLR_CLR11: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR11_SHIFT (11)
#define SCT_OUTn_CLR_CLR11_MASK (0x01 << SCT_OUTn_CLR_CLR11_SHIFT)
#define SCT_OUTn_CLR_CLR11(x) ((x) << SCT_OUTn_CLR_CLR11_SHIFT)

/* -- SCT_OUTn_CLR_CLR12: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR12_SHIFT (12)
#define SCT_OUTn_CLR_CLR12_MASK (0x01 << SCT_OUTn_CLR_CLR12_SHIFT)
#define SCT_OUTn_CLR_CLR12(x) ((x) << SCT_OUTn_CLR_CLR12_SHIFT)

/* -- SCT_OUTn_CLR_CLR13: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR13_SHIFT (13)
#define SCT_OUTn_CLR_CLR13_MASK (0x01 << SCT_OUTn_CLR_CLR13_SHIFT)
#define SCT_OUTn_CLR_CLR13(x) ((x) << SCT_OUTn_CLR_CLR13_SHIFT)

/* -- SCT_OUTn_CLR_CLR14: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR14_SHIFT (14)
#define SCT_OUTn_CLR_CLR14_MASK (0x01 << SCT_OUTn_CLR_CLR14_SHIFT)
#define SCT_OUTn_CLR_CLR14(x) ((x) << SCT_OUTn_CLR_CLR14_SHIFT)

/* -- SCT_OUTn_CLR_CLR15: A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 15 = bit 15. */
#define SCT_OUTn_CLR_CLR15_SHIFT (15)
#define SCT_OUTn_CLR_CLR15_MASK (0x01 << SCT_OUTn_CLR_CLR15_SHIFT)
#define SCT_OUTn_CLR_CLR15(x) ((x) << SCT_OUTn_CLR_CLR15_SHIFT)
